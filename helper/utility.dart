...
import '../widgets/newWidget/custom_loader.dart';
...
class Utility {
  ...
  static List<String> getHashTags(String text) {
    ...
    for (Match match in _matches) {
      if (match.group(0)!.isNotEmpty) {
        ...
        resultMatches.add(tag as String);
      }
    }
  ...
  static void customSnackBar(GlobalKey<ScaffoldState> _scaffoldKey, String msg,
  ...
  static void createLinkAndShare(BuildContext context, String id,
      {SocialMetaTagParameters? socialMetaTagParameters}) async {
  ...
  static void shareFile(List<String> path, {String text = ''}) {
    try {
      print("hello");
  ...
  static void copyToClipBoard({
    ...
    customSnackBar(scaffoldKey as GlobalKey<ScaffoldState>, message as String);
  }
}
