...
import 'package:racfmn/ui/page/common/update_app.dart';
...
Future.delayed(Duration(milliseconds: 100)).then((_) {
  ...
  Future<String> _getAppVersionFromFirebaseConfig() async {
    ...
    final response = await DefaultAssetBundle.of(context).loadString('assets/json/config.json').catchError((error) {
      throw error;
    });
    print(response);
    final responseData = jsonDecode(response);
    print(responseData);
    //var data = responseData.getString('appVersion');
