...
class SpiritualTab extends StatefulWidget {
 // PaperTab({Key? key}) : super(key: key);
 @override
 _SpiritualTabState createState() => _SpiritualTabState();

}
class _SpiritualTabState extends State<SpiritualTab> {
static const _pageSize = 9;
static const postsType = "Spiritual";
 //Api api = Api();
