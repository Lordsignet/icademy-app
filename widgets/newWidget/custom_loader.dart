...
class CustomLoader {
  ...
  factory CustomLoader() {
    if (_customLoader != null) {
      return _customLoader as CustomLoader;
    } else {
  ...
  dynamic showLoader(context) {
    _overlayState = Overlay.of(context) as OverlayState;
    _buildLoader();
    _overlayState!.insert(_overlayEntry as OverlayEntry);
  }
  ...
  dynamic buildLoader(BuildContext context, {Color? backgroundColor}) {
