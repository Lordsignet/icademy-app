    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          AnimatedBuilder(
            animation: _animationController as AnimationController,
            builder: (BuildContext context, child) => FractionallySizedBox(
              widthFactor: _progressTween!.value,
              child: Padding(
                  padding: widget.innerPadding as EdgeInsetsGeometry,
                  child: child),
            ),
            child: Container(
              height: widget.height,
